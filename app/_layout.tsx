...
function RootLayoutNav() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="new-crew"
        options={{ presentation: "modal", title: "New Crew Member" }}
      />
      <Stack.Screen
        name="new-schedule-day"
        options={{ presentation: "modal", title: "New Shoot Day" }}
      />
      <Stack.Screen
        name="log-take"
      ...
      <Stack.Screen
        name="new-breakdown"
        options={{ presentation: "modal", title: "New Breakdown" }}
      />
      <Stack.Screen name="locations" options={{ title: "Locations" }} />
      <Stack.Screen
        name="new-location"
        options={{ presentation: "modal", title: "New Location" }}
      />
      <Stack.Screen name="budget" options={{ title: "Budget" }} />
      <Stack.Screen
        name="new-budget-item"
        options={{ presentation: "modal", title: "New Budget Item" }}
      />
      <Stack.Screen
        name="digital-slate"
        options={{
      ...
      <Stack.Screen
        name="new-continuity"
        options={{ presentation: "modal", title: "New Continuity Note" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="new-vfx"
        options={{ presentation: "modal", title: "New VFX Shot" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="new-festival"
        options={{ presentation: "modal", title: "New Festival" }}
      />
      ...
      <Stack.Screen
        name="new-mood-item"
        options={{ presentation: "modal", title: "New Mood Item" }}
      />
      ...
      <Stack.Screen
        ...
        options={{ presentation: "modal", title: "New Reference" }}
      />
      <Stack.Screen name="wrap-reports" options={{ title: "Wrap Reports" }} />
      <Stack.Screen
        name="new-wrap-report"
        options={{ presentation: "modal", title: "New Wrap Report" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        options={{ presentation: "modal", title: "New Blocking Note" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        options={{ presentation: "modal", title: "New Cast Member" }}
      />
      <Stack.Screen
        name="shot-checklist"
      ...
      <Stack.Screen
        ...
        options={{ presentation: "modal", title: "New Lookbook Item" }}
      />
