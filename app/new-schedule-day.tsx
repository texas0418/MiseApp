...
export default function NewScheduleDayScreen() {
  ...
  const { addScheduleDay, activeProjectId, activeProject, schedule } = useProjects();
  ...
  const handleSave = useCallback(() => {
    ...
    router.back();
  }, [activeProjectId, date, scenes, location, callTime, wrapTime, notes, nextDayNumber, addScheduleDay, router]);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <View style={styles.projectLabel}>
        <Text style={styles.projectLabelText}>Day {nextDayNumber} for: {activeProject.title}</Text>
      </View>
      ...
      <View style={styles.field}>
        ...
        <TextInput
          style={styles.input}
          value={scenes}
          onChangeText={setScenes}
          placeholder="e.g. Sc. 1, 5, 8"
          placeholderTextColor={Colors.text.tertiary}
        />
      </View>
      ...
      <View style={styles.field}>
        ...
        <TextInput
          ...
          placeholder="Weather contingency, special equipment, etc."
          placeholderTextColor={Colors.text.tertiary}
          multiline
          numberOfLines={3}
      ...
      <TouchableOpacity style={styles.saveButton} onPress={handleSave} activeOpacity={0.8} testID="save-schedule-button">
        <Text style={styles.saveButtonText}>Add Shoot Day</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
